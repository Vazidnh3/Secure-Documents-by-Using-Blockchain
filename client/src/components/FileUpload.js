    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `fd751cb2911b4f417568`,
            pinata_secret_api_key: `aeb569c87eb044004885618269678eb02c6abdfc246b6e585b46937ef00734a6`,
        ...
        console.error("Error uploading document to Pinata:", e);
